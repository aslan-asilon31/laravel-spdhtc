<nav class="navbar fixed-top navbar-expand-lg color-fren-green" data-aos="fade-down" >
    <div class="container">
        <a class="navbar-brand font-semibold pe-none" href="#" style="color:white !important;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 font-medium">
                <li class="nav-item">
                    <a class="nav-link beranda" href="#beranda" style="color:white !important;">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link diagnosis" href="#diagnosis" style="color:white !important;">Diagnosa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link penyakit" href="#penyakit" style="color:white !important;">Informasi Penyakit</a>
                </li>
            </ul>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="{{ route('edit-profile') }}" class="nav-link" id="btnNavLinkProfile">
                            <div class="d-grid">
                                <button class="btn btn-outline-dark font-medium text-start" style="color:white !important;">
